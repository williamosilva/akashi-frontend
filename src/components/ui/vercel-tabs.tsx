    ...
    return (
      <div ref={ref} className={cn("relative", className)} {...props}>
        <div className="relative">
          ...
          {/* Active Indicator */}
          <div
            className="absolute bottom-[-6px] h-[2px] bg-emerald-500 dark:bg-emerald-500 transition-all duration-300 ease-out"
            style={activeStyle}
          />
              ...
              <div
                ...
                className={cn(
                  ...
                  index === activeIndex
                    ...
                    : "text-zinc-400 dark:text-zinc-400 hover:text-emerald-400 dark:hover:text-emerald-400"
                )}
