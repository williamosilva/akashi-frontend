  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onSave}
        className="w-full flex-1 sm:w-auto px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-green-500 text-white text-sm font-medium hover:from-emerald-600 hover:to-green-600 transition-all duration-200 flex items-center justify-center shadow-lg "
      >
